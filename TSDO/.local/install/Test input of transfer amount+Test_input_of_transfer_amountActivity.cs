...
namespace TSDO
{
    public class Test_input_of_transfer_amountActivity : System.Activities.Activity
    {
        public Test_input_of_transfer_amountActivity()
        {
            this.Implementation = () =>
            {
                return new Test_input_of_transfer_amountActivityChild()
                {};
            };
        }
    }

    internal class Test_input_of_transfer_amountActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Test_input_of_transfer_amountActivityChild()
        {
            DisplayName = "Test_input_of_transfer_amount";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Test_input_of_transfer_amount();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Test input of transfer amount.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Test input of transfer amount.cs", Exception = exception});
                }
