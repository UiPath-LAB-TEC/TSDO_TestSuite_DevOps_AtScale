...
namespace TSDO
{
    public class Verify_transaction_history_updateActivity : System.Activities.Activity
    {
        public Verify_transaction_history_updateActivity()
        {
            this.Implementation = () =>
            {
                return new Verify_transaction_history_updateActivityChild()
                {};
            };
        }
    }

    internal class Verify_transaction_history_updateActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Verify_transaction_history_updateActivityChild()
        {
            DisplayName = "Verify_transaction_history_update";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Verify_transaction_history_update();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Verify transaction history update.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Verify transaction history update.cs", Exception = exception});
                }
