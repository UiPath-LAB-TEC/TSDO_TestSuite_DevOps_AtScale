...
namespace TSDO
{
    public class Test_transfer_executionActivity : System.Activities.Activity
    {
        public Test_transfer_executionActivity()
        {
            this.Implementation = () =>
            {
                return new Test_transfer_executionActivityChild()
                {};
            };
        }
    }

    internal class Test_transfer_executionActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Test_transfer_executionActivityChild()
        {
            DisplayName = "Test_transfer_execution";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Test_transfer_execution();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Test transfer execution.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Test transfer execution.cs", Exception = exception});
                }
