...
namespace TSDO
{
    public class Verify_transfer_confirmation_dialogActivity : System.Activities.Activity
    {
        public Verify_transfer_confirmation_dialogActivity()
        {
            this.Implementation = () =>
            {
                return new Verify_transfer_confirmation_dialogActivityChild()
                {};
            };
        }
    }

    internal class Verify_transfer_confirmation_dialogActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Verify_transfer_confirmation_dialogActivityChild()
        {
            DisplayName = "Verify_transfer_confirmation_dialog";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Verify_transfer_confirmation_dialog();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Verify transfer confirmation dialog.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Verify transfer confirmation dialog.cs", Exception = exception});
                }
