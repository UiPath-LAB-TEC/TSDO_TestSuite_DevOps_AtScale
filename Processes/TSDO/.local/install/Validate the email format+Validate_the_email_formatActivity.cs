...
namespace TSDO
{
    public class Validate_the_email_formatActivity : System.Activities.Activity
    {
        public Validate_the_email_formatActivity()
        {
            this.Implementation = () =>
            {
                return new Validate_the_email_formatActivityChild()
                {};
            };
        }
    }

    internal class Validate_the_email_formatActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Validate_the_email_formatActivityChild()
        {
            DisplayName = "Validate_the_email_format";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Validate_the_email_format();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate the email format.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate the email format.cs", Exception = exception});
                }
