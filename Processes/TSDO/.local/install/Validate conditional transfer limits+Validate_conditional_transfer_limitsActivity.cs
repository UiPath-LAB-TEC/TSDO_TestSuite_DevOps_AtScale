...
namespace TSDO
{
    public class Validate_conditional_transfer_limitsActivity : System.Activities.Activity
    {
        public Validate_conditional_transfer_limitsActivity()
        {
            this.Implementation = () =>
            {
                return new Validate_conditional_transfer_limitsActivityChild()
                {};
            };
        }
    }

    internal class Validate_conditional_transfer_limitsActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Validate_conditional_transfer_limitsActivityChild()
        {
            DisplayName = "Validate_conditional_transfer_limits";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Validate_conditional_transfer_limits();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate conditional transfer limits.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate conditional transfer limits.cs", Exception = exception});
                }
