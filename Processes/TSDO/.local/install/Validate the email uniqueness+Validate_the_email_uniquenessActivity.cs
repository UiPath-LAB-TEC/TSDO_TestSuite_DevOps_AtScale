...
namespace TSDO
{
    public class Validate_the_email_uniquenessActivity : System.Activities.Activity
    {
        public Validate_the_email_uniquenessActivity()
        {
            this.Implementation = () =>
            {
                return new Validate_the_email_uniquenessActivityChild()
                {};
            };
        }
    }

    internal class Validate_the_email_uniquenessActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public Validate_the_email_uniquenessActivityChild()
        {
            DisplayName = "Validate_the_email_uniqueness";
        }
        ...
        {
            var codedWorkflow = new global::TSDO.Validate_the_email_uniqueness();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate the email uniqueness.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "Validate the email uniqueness.cs", Exception = exception});
                }
